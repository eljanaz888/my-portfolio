...
const Data = () => {
    return (
        <div className='home__data'>
            <h1 className='home__title'>Eljana Zeqiraj
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
                ...
                <p className='home__description'>I am a developer based in Tirana, Albania and i am very passionate and dedicated to my work.</p>
